                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                              ...
                              <div class="container-fluid">
                                  ...
                                  <div class="card-body">
                                    ...
                                    <form action="" method="post">
                                      <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <?php
                                        $no=1;
                                        $a="SELECT * FROM konsul_offline INNER JOIN dokter ON dokter.id_dokter=konsul_offline.id_dokter
                                                                         INNER JOIN register ON dokter.username_dokter=register.username";
                                        $b=$koneksi->query($a);
                                          ...
                                          <tbody>
                                            <tr>
                                              ...
                                              <td>
                                                ...
                                                if($c['keputusan']==0){
                                                  ?>
                                                  <a href="terima_konsul_offline.php?id=<?php echo $c['id']?>" class='btn btn-info btn-square'>Pending</a>
                                                <?php
                                                  }elseif($c['keputusan']==1){
                                                    echo"<button class='btn btn-primary btn-square'>Diterima</button>";
                                                  }
                                                  ?>
                                                </td>
                                ...
                                <input type="submit" class="btn btn-danger btn-square" value="Hapus" name="proses"></input>
                                    <?php
                                    if(isset($_POST['proses'])){
                                      $id=$_POST['id'];
                                      $sql="DELETE FROM konsul_offline WHERE id='$id'";
                              ...
                              ?>
                                ...
                                <?php
                                $sql="SELECT * FROM konsul_offline INNER JOIN dokter ON dokter.id_dokter=konsul_offline.id_dokter
                                                                   INNER JOIN register ON dokter.username_dokter=register.username";
                                $query=$koneksi->query($sql);
                                $no=1;
